...
namespace BankingApplication
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ////a visa account
            // Perform transactions for Visa accounts
            ...
            a.DoPurchase(39, p1);
            a.DoPayment(400, p0);
            Console.WriteLine(a);  // Print the result of operations
            ...
            //a saving account
            // Step 4: Perform operations on Saving accounts
            ITransaction1 b = Bank.GetAccount("SV-100002");
            b.Withdraw(300, p6);
            b.Withdraw(32.90, p6);
            b.Withdraw(50, p7);
            ...
            //a checking account
            // Step 5: Perform operations on Checking accounts
            ITransaction1 c = Bank.GetAccount("CK-100004");
            c.Deposit(33.33, p7);
            c.Deposit(40.44, p7);
            c.Withdraw(150, p2);
            c.Withdraw(200, p4);
            c.Withdraw(645, p6);
            c.Withdraw(350, p6);
            Console.WriteLine(c); // Print the result of operations
